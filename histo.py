...
DATA_PATH = Path("/Users/ridhamjoshi/Desktop/hackathont/Hackathon_test/Historical Data.csv")

MODEL_PATH = Path("app/services/risk/models/risk_model.joblib")
...
def build_features(df):
    ...
    df["shipment_hour"] = pd.to_datetime(df["Declaration_Time"]).dt.hour
